...
class UrlsExtractSpider(CrawlSpider,):
    ...
    custom_settings = {
    'ITEM_PIPELINES': {'online_mall_crawl.pipelines.OutletProductsPipeline': 305},
    ...
    def start_requests(self):
        yield scrapy.Request('https://www.asos.com/women/outlet/cat/?cid=27391&nlid=ww|outlet|shop+by+product',dont_filter=True)
