...
class UrlsExtractSpider(CrawlSpider,):
    name = 'athletic_wear_products'
    allowed_domains = ['asos.com']
    custom_settings = {
    'ITEM_PIPELINES': {'online_mall_crawl.pipelines.AthleticWearProductsPipeline': 303},
    ...
    def start_requests(self):
        yield scrapy.Request('https://www.asos.com/women/activewear/cat/?cid=26091&nlid=ww|activewear|shop+by+product',dont_filter=True)
