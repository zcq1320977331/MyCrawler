...
class UrlsExtractSpider(CrawlSpider,):
    ...
    custom_settings = {
    'ITEM_PIPELINES': {'online_mall_crawl.pipelines.NewProductPipeline': 300},
    ...
    def start_requests(self):
        yield scrapy.Request('https://www.asos.com/women/new-in/cat/?cid=27108&nlid=ww|new+in|new+products',dont_filter=True)
