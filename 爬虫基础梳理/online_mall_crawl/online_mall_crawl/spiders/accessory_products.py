...
class UrlsExtractSpider(CrawlSpider,):
    ...
    custom_settings = {
    'ITEM_PIPELINES': {'online_mall_crawl.pipelines.AccesssoryProductsPipeline': 302},
    ...
    def start_requests(self):
        yield scrapy.Request('https://www.asos.com/women/accessories/cat/?cid=4174&nlid=ww|accessories|shop+by+product',dont_filter=True)
